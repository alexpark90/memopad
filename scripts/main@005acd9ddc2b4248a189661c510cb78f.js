/*
    ...
    Files:  index.html - The main page that has the memo pad.
...
// when body is loaded, it sets global variables and check if there is already text on the first page of the memo         
function reload()
{
